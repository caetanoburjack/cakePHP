...
;   E_COMPILE_ERROR|E_RECOVERABLE_ERROR|E_ERROR|E_CORE_ERROR  (Show only errors)
     ...
     */
    'Error' => [
        'errorLevel' => E_COMPILE_ERROR | E_RECOVERABLE_ERROR | E_ERROR | E_CORE_ERROR,
        'skipLog' => [],
        'log' => true,
        'trace' => true,
    ...
    'Log' => [
        'debug' => [
            ...
            'scopes' => false,
            'levels' => ['debug'], //It is possible to add 'notice', 'info',
        ],
        'error' => [
            'ignoredDeprecationPaths' => [
            ...
            'scopes' => false,
            'levels' => ['error'],//It is possible to add 'warning', 'error', 'critical', 'alert', 'emergency'
        ],
